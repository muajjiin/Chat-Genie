...
React.useEffect(() => {
  ...
  return selectedUser ? (
    <div className="h-full overflow-y-auto relative backdrop-blur-lg">
      ...
      {/*------bottom area-------*/}
      <div className='absolute bottom-0 left-0 right-0 flex items-center gap-3 p-3 bg-white/5'>
        <input type="text" placeholder='Send a message' className="flex-1 p-2 rounded-full bg-white/20 text-white" />
